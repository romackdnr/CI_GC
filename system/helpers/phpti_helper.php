...
if ( ! function_exists('simpleblock'))
{
...
if ( ! function_exists('getsuperblock'))
{
...
if ( ! function_exists('flushblocks'))
{
...
if ( ! function_exists('_ti_newBlock'))
{
...
if ( ! function_exists('_ti_insertBlock'))
{
...
if ( ! function_exists('_ti_bufferCallback'))
{
...
if ( ! function_exists('_ti_compile'))
{
...
if ( ! function_exists('_ti_warning'))
{
...
if ( ! function_exists('_ti_callingTrace'))
{
...
if ( ! function_exists('_ti_inBaseOrChild'))
{
...
if ( ! function_exists('_ti_isSameFile'))
{
...
if ( ! function_exists('_ti_isSubtrace'))
{
